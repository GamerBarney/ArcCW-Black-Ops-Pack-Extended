...
SWEP.ViewModel = "models/weapons/arccw/c_bo1_ithaca_long.mdl"
...
SWEP.WorldModel = "models/weapons/arccw/c_bo1_ithaca_long.mdl"
...
SWEP.CustomizePos = Vector(10, 0, -3)
...
SWEP.AttachmentElements = {
    ["papname1"] = {
        NamePriority = 10,
        TrueNameChange = "Assault",
        NameChange = "This Machine",
    },
    ["light_stock"] = {
        VMBodygroups = {
            {ind = 4, bg = 1},
