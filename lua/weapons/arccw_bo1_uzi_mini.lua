...
SWEP.ViewModel = "models/weapons/arccw/c_bo1_uzi_mini.mdl"
SWEP.WorldModel = "models/weapons/arccw/c_bo1_uzi_mini.mdl"
...
SWEP.Attachments = {
    { --1
        ...
        Offset = {
            vpos = Vector(-4, 0, 3), -- 4.6 offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 0),
